public class Nursery extends Room {
    ...
    public Nursery(String name, String description, int darknessLevel, Monster[] monsters, boolean hasLullabyMusic, boolean hasRockingChair, int toyScatteringLevel) {
